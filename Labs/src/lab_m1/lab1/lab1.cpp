...
void Lab1::Update(float deltaTimeSeconds)
{
   ...
   RenderMesh(meshes["plane50"], glm::vec3(xp, yp, zp), glm::vec3(0.1f));
    ...
    RenderMesh(meshes[obj], glm::vec3(1.f, 1.f, 2.f), glm::vec3(0.5f));
}
...
void Lab1::OnInputUpdate(float deltaTime, int mods)
{
    ...
    //bonus rotatie in jurul originii
