    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
           // VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            ...
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(.25f, .25f, 1.f)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.1f, .25f, 1.f)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(.25f, 1.f, 1.f)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(.75f, .25f, .25f)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1.f, .5f, .5f)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(.025f, .75f, .75f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1.f, 1.f, .5f)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(.5f, 1.f, .5f))
        ...
        vector<VertexFormat> tetVert =
        {
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1.f, .5f, .5f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(.025f, .75f, .75f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1.f, 1.f, .5f)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(.5f, 1.f, .5f))
        };
        ...
        vector<VertexFormat> sqVert =
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1.f, .5f, .5f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(.025f, .75f, .75f)),
            VertexFormat(glm::vec3(0, 1 , 1), glm::vec3(.025f, .75f, .75f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(.025f, .75f, .75f))
       ...
       meshes["cube_A"]->InitFromData(vertices, indices);
        ...
        CreateMesh("tetraedru", tetVert, tetInd);
        CreateMesh("patrat", sqVert, sqInd);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1, -1, 1), glm::vec3(0.25f));
